// About IIEF : // https://stackoverflow.com/questions/8228281/what-is-the-function-construct-in-javascript
// OOP : https://poiemaweb.com/js-object-oriented-programming
// OOP: https://webclub.tistory.com/374
// https://untitledtblog.tistory.com/102
var techanSite = techanSite || {}; // 없으면 리터럴 방식으로 클래스 생성

techanSite.bigchart = (function(d3, techan, sdata) {
    'use strict';
    ...
    function BigChart() {
        ...
        bigchart.setdata = function (new_stock) {
            stock = new_stock
            //data = new_stock_data.ohlc
            //console.log(stock.name);
        }

        bigchart.update = function(selection) {
            selection.call(draw);
        ...
        function draw(selection) {
            ...
            svg.select("text.symbol").text(stock.name);
